...
<html lang="en">
  ...
  <title>datasciencecoursera/PA1_template.Rmd at master · rayryeng/datasciencecoursera</title>
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MzA0MTMxNDI1OmU2NTUxYThmNDQ1YmY3MGNmODkxZWQ3NDAwY2ViZGZkYjZlN2RjM2FlYjM5ZjA2NTE3ZWVkZDQyZmQzOGQ0ZWI=--4c281c81f29ffc8741f96b518829174321a78486">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="1CCC:1254:B18396:14BACB9:5B79AB06" data-pjax-transient>
...
<meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="octolytics-dimension-user_id" content="765375" /><meta name="octolytics-dimension-user_login" content="rayryeng" /><meta name="octolytics-dimension-repository_id" content="18779023" /><meta name="octolytics-dimension-repository_nwo" content="rayryeng/datasciencecoursera" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="18779023" /><meta name="octolytics-dimension-repository_network_root_nwo" content="rayryeng/datasciencecoursera" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />
    ...
    <link rel="canonical" href="https://github.com/rayryeng/datasciencecoursera/blob/master/RepData_PeerAssessment1/PA1_template.Rmd" data-pjax-transient>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="18779023" data-scoped-search-url="/rayryeng/datasciencecoursera/search" data-unscoped-search-url="/search" action="/rayryeng/datasciencecoursera/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=mlivJGqffclUbANtKTRGgPcFK9XRW1RPjKH1hkZ3V5Ljbz3AmrtxF8CcFwnH18uE0NpkkNxno3+HTVvG0ppiiA=="
          spellcheck="false"
          autocomplete="off"
          >
...
<a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
    ...
    <details class="details-overlay details-reset d-flex pl-2 flex-items-center">
      ...
      <details-menu class="dropdown-menu dropdown-menu-sw">
        <ul>
          ...
          <li>
            <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="U/B0Zkt6SYB8ccD2liWAFTbH/3qGRXjFweoO6YUAN15ZwTEZfS/dFWy3fbGzB37NFY/HIB/goFvN1uq2xNHxAw==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="ZH5aqakl83X7HkwpL+Hl/cgR1dGpkq62GDHXKdd+SfduTx/Wn3Bn4OvY8W4Kwxsl61ntizA3digUDTN2lq+Pqg==" />
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="tC1p8/dXxodce/35X65c/2mmCi3/GwKcCX6Ditg5VJI+i1aBHtPEI9n42C9n7CoinyNaS2P3PJ0YxNjf5rcpvA==" />      <input type="hidden" name="repository_id" id="repository_id" value="18779023" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/rayryeng/datasciencecoursera/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="zt4yPi6tyCS18GZMonS+8oKI7rf1osmKNeKb9JltkNB1Hefk7qAZQAmFQgNjQIg+wRXySfjVck8tOEWuRVUqZQ==" />
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/rayryeng/datasciencecoursera/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="ZQOVIv6FmX4AMGcBN4X9B1kEEBkHCcnSYzkeqFzhY3HiGk2SCSvi1ulNWgsSGcxb2qRFYjJ7YZXb6XYMoCTErA==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/rayryeng/datasciencecoursera/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="XG7priEMkYc+mHNWWLrT1DJpZnS5sYjvw2lhmqELYbULHlw9jvmRVuyf1UOWgZXT18l3UYCdumxID2oCEQEimw==" />
            <button
                type="submit"
  ...
  <span class="author" itemprop="author"><a class="url fn" rel="author" href="/rayryeng">rayryeng</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a data-pjax="#js-repo-pjax-container" href="/rayryeng/datasciencecoursera">datasciencecoursera</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    ...
    <a data-hotkey="g b" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /rayryeng/datasciencecoursera/projects" href="/rayryeng/datasciencecoursera/projects">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/rayryeng/datasciencecoursera/blob/a222864659ae509e98bd1536dabe45ec3042ef4f/RepData_PeerAssessment1/PA1_template.Rmd">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:09f6544b281f732782c2292544580d8e -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/rayryeng/datasciencecoursera/blob/master/RepData_PeerAssessment1/PA1_template.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
  ...
  <include-fragment src="/rayryeng/datasciencecoursera/contributors/master/RepData_PeerAssessment1/PA1_template.Rmd" class="commit-tease commit-loader">
    <div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/rayryeng/datasciencecoursera/raw/master/RepData_PeerAssessment1/PA1_template.Rmd">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/rayryeng/datasciencecoursera/blame/master/RepData_PeerAssessment1/PA1_template.Rmd">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/rayryeng/datasciencecoursera/commits/master/RepData_PeerAssessment1/PA1_template.Rmd">History</a>
    </div>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form js-update-url-with-hash" action="/rayryeng/datasciencecoursera/edit/master/RepData_PeerAssessment1/PA1_template.Rmd" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="WpnNQkJW0Z2JV6XQ/QrRO1v0OZsll2bxpnkyefnMHPRJQZhj9hG27u+lx2lyzaHQvRtfBGWQHashjBXCW7zzFw==" />
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg class="octicon octicon-pencil" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form" action="/rayryeng/datasciencecoursera/delete/master/RepData_PeerAssessment1/PA1_template.Rmd" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="+Pfa05HYQBLJhFl4fhqchYOmp/5vUrHL+4DR8sR2CKLkhPtN/SMbXiLcjE7LA2WcKFlS+Gw0yxjmWiBjwfA0Eg==" />
...
<pre lang="{r"><code>unzip("activity.zip") # Unzip archive
...
<pre lang="{r"><code># Part 2 - Create a histogram of the total number of steps taken
# each day
...
<pre lang="{r"><code>meanStepsPerDay &lt;- sapply(stepsSplit, mean, na.rm=TRUE)
meanDataFrame &lt;- data.frame(date=uniqueDates, meanStepsPerDay=meanStepsPerDay, row.names=NULL)
meanDataFrame
</code></pre>
<p>The median steps per day are:</p>
<pre lang="{r"><code>medianStepsPerDay &lt;- sapply(stepsSplit, median, na.rm=TRUE)
...
<pre lang="{r"><code>stepsSplit[10:12]
</code></pre>
...
<pre lang="{r"><code># Part 3 - Time-series plot (type="l")
...
<pre lang="{r"><code># Part 4 - Calculate total amount of missing values in the data set
...
<pre lang="{r"><code># Modify the meanStepsPerDay vector that contains the mean steps taken
...
<pre lang="{r"><code># Repeat Part 2 now
# First split up the data frame for steps by day
...
<pre lang="{r"><code>meanStepsPerDayNew &lt;- sapply(stepsSplitNew, mean)
...
<pre lang="{r"><code>medianStepsPerDayNew &lt;- sapply(stepsSplitNew, median)
...
<pre lang="{r"><code># Part 5 - Now split up the data so that it's sorted by weekday or weekend
...
<pre lang="{r"><code># Further split up the Weekdays and Weekends into their own intervals
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.21398s from unicorn-7967df4c7c-fssph">GitHub</span>, Inc.</li>
